...
describe('zrevrangebyscore', () => {
  ...
  it('should return using not strict compare', () => {
    ...
    return redis.zrevrangebyscore('foo', 3, 1).then(res => {
  ...
  it('should return using strict compare', () => {
    ...
    return redis.zrevrangebyscore('foo', 5, '(3').then(res => {
      return expect(res).toEqual(['fifth', 'fourth'])
    })
  })
  ...
  it('should accept infinity string', () => {
    ...
    return redis.zrevrangebyscore('foo', '+inf', '-inf').then(res => {
  ...
  it('should return empty array if out-of-range', () => {
    ...
    return redis.zrevrangebyscore('foo', 100, 10).then(res => {
      return expect(res).toEqual([])
    })
  })
  ...
  it('should return empty array if key not found', () => {
    ...
    return redis.zrevrangebyscore('boo', 100, 10).then(res => {
      return expect(res).toEqual([])
    })
  })
  ...
  it('should return empty array if the key contains something other than a list', () => {
    ...
    return redis.zrevrangebyscore('foo', 2, 1).then(res => {
      return expect(res).toEqual([])
    })
  })
  ...
  it('should include scores if WITHSCORES is specified', () => {
    const redis = new Redis({ data })
    return redis.zrevrangebyscore('foo', 3, 1, 'WITHSCORES').then(res => {
      return expect(res).toEqual(['third', 3, 'second', 2, 'first', 1])
    })
  })
  ...
  it('should sort items with the same score in reverse lexicographical order', () => {
    ...
    return redis
      ...
      .then(res => {
        return expect(res).toEqual(['aaa', 5, 'ddd', 4, 'ccc', 4, 'bbb', 4])
      })
  })

  it('should handle offset and limit (0,1)', () => {
    const redis = new Redis({ data })
    return redis.zrevrangebyscore('foo', 3, 1, 'LIMIT', 0, 1).then(res => {
      return expect(res).toEqual(['third'])
    })
  })
  it('should handle offset and limit (1,2)', () => {
    const redis = new Redis({ data })
    return redis.zrevrangebyscore('foo', 3, 1, 'LIMIT', 1, 2).then(res => {
      return expect(res).toEqual(['second', 'first'])
    })
  })
  it('should handle offset, limit, and WITHSCORES', () => {
    ...
    return redis
      ...
      .then(res => {
        return expect(res).toEqual(['second', 2])
      })
  })
  ...
  it('should handle LIMIT of -1', () => {
    ...
    return redis
      ...
      .then(res => {
        return expect(res).toEqual(['fourth', 'third', 'second'])
      })
  })
  it('should handle LIMIT of -1 and WITHSCORES', () => {
    ...
    return redis
      ...
      .then(res => {
        return expect(res).toEqual(['fourth', 4, 'third', 3, 'second', 2])
      })
  })
  it('should handle LIMIT of -2', () => {
    ...
    return redis
      ...
      .then(res => {
        return expect(res).toEqual(['fourth', 'third'])
      })
  })
