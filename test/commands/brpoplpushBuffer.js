...
describe('brpoplpushBuffer', () => {
  it('should remove one item from the tail of the source list', () => {
    ...
    return redis.brpoplpushBuffer('foo', 'bar')
  ...
  it('should return null if the source list does not exist', () => {
    ...
    return redis.brpoplpushBuffer('foo', 'bar').then(item => expect(item).toEqual(null));
  });
  ...
  it('should return the item', () => {
    ...
    return redis.brpoplpushBuffer('foo', 'bar').then(item => expect(item).toBe('bar'));
  });
  ...
  it('should return buffer values correctly', () => {
    ...
    return redis.brpoplpushBuffer('foo', bufferVal).then(item => expect(item).toBe(bufferVal));
  });
